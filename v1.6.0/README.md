...
Version 1.6 is a ground-up port of 1.5 from Electron to Tauri. You keep the same UX you had — now with a ~10× smaller installer, lower memory use, and a safer native backend.
